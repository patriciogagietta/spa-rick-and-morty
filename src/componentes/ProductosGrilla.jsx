...
export const ProductosGrilla = () => {
    ...
    const { producto, handleAgregarFavorito, personajeIsFavorito, handlePaginaSiguiente, handlePaginaAnterior, page, pageFinalPersonajes } = useProductos(); 

    if (!producto) 
        return (
        <div className="text-center font-bold text-2xl mt-28">Cargando...</div>
    );
